...
init_sleep = 10
# This is intended to signal that the application is up and healthy.
...
def crash():
    ...
    # To do this we just remove the application status file
    ...
    def start_loop():
        ...
        while not_started:
            try:
                ...
                # err = True
                logger.info('The server not yet started')
            time.sleep(2)
...
if __name__ == "__main__":
    ...
    logging.basicConfig(format='%(message)s',
                        datefmt='%Y-%m-%d,%H:%M:%S', level=logging.INFO)
    logger.info("==========================================================")
    logger.info("Starting Sample Python Web Application")
